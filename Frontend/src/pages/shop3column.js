...
import Shop_category1 from "./shooop.js";

  import { useState, useEffect } from "react";

class Shop3column extends React.Component{
    render(){
        return(
        <div>
            <div id="main">
             ...
             <ul className="mega-menu-wrap">
               <li>
                 <ul>
                   ...
                   <li><Link to="/shop3column">Shop Grid 3 Column</Link></li>
    ...
    <div className="col-md-12">
     <div className="breadcrumb-content">
       <h1 className="breadcrumb-hrading">Shop 3 Column</h1>
